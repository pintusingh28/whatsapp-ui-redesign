...
class WhatsappRedesignTheme with Diagnosticable {
  ...
  ThemeData get lightTheme {
    const colorScheme = ColorScheme(
      ...
      primaryContainer: Color(0xFFB8E7CF),
      onPrimaryContainer: Color(0xFF0D7A42),
      secondary: Color(0xFF12AE5E),
      onSecondary: Color(0xFF000000),
      secondaryContainer: Color(0xFFB8E7CF),
      onSecondaryContainer: Color(0xFF0D7A42),
  ...
  ThemeData get darkTheme {
    const colorScheme = ColorScheme(
      ...
      primary: Color(0xFF12AE5E),
      onPrimary: Color(0xFF000000),
      primaryContainer: Color(0xFF05341C),
      onPrimaryContainer: Color(0xFF59C68E),
      secondary: Color(0xFF12AE5E),
      onSecondary: Color(0xFF000000),
      secondaryContainer: Color(0xFF05341C),
      onSecondaryContainer: Color(0xFF59C68E),
      error: Color(0xFFFF3508),
      onError: Color(0xFFFFFFFF),
